...
public abstract class AbstractSorter {
	 ...
	 * 
	 * @param order
	 *            0 by x-coordinate 1 by y-coordinate 2 by polar angle w.r.t
	 *            referencePoint
	 * 
	 * @throws IllegalArgumentException
	 *             if order is less than 0 or greater than 2 IllegalStateException
	 *             if order == 2 and referencePoint == null;
	 */
	public void setComparator(int order) throws IllegalArgumentException, IllegalStateException {
		...
		if (order == 2) {
			...
			// compare polar angle by referencePoint
			// call setReferencePoint
